<?php
class comarquage_BlockComarquageSuccessView extends block_BlockView
{
    /**
    ...
    {
    	$this->setTemplateName('Comarquage-Block-Comarquage-Success');
    	$this->setAttribute('content', $this->getParameter('content'));
    }
}